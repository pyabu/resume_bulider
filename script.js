...
window.toggleSection = function(header) {
    const section = header.closest('.editor-section, .editor-card');
...
function importJSON(e) {
    ...
    reader.onload = function (event) {
        try {
            ...
            renderPreview();
            renderSkillsTags();
            updateColor(resumeData.color || '#6366f1');
            document.getElementById('color-picker').value = resumeData.color || '#6366f1';
